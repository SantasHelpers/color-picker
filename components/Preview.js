...
import {HEXtoRGB, rgbToHsl, HSLtoRGB, hexToGrayscale} from './colorCalcHelpers.js';
import hsltohex from 'hsl-to-hex';
import hexToHsl from 'hex-to-hsl';
import colorStore from './colorStore';
import { observer } from 'mobx-react';

var Preview = observer(({location: {query}}) => {
  ...
  var setStyles = function() {
    ...
    styles.headersMid.color = generatedColor6;
    styles.headersRight.color = generatedColor6;
    styles.links.color = query.color5;

  }();

  console.log(colorStore.color1);

  return (
    <div id="container">
      <div><FilterBar/></div>
      <main id="center" className="column" style={styles.headerFooter}>
        <article>
          <h1>Heading</h1>
        </article>
      </main>
      <div id="columnholder">
        <nav id="left"className="column" style={styles.left}>
        ...
        <div id="innermid">
          <h2 style={styles.headersMid}>Lorem Ipsum</h2>
        ...
        <div id="right" className="column" style={styles.right}>
